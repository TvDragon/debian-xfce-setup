...
cd
sudo nala install xfwm4 xfce4-terminal xfce4-settings xfce4-session xfce4-taskmanager xfce4-notifyd xfce4-screenshooter ristretto xfce4-panel xfce4-panel-profiles xfce4-power-manager-plugins xfce4-pulseaudio-plugin xfce4-whiskermenu-plugin xfce4-windowck-plugin -y
